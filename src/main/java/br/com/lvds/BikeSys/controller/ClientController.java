...
public class ClientController {
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<?> deleteClient(@PathVariable("id") BigInteger clientId) throws Exception {
        return ResponseEntity.ok(new GenericResponse<>(service.deleteClient(clientId)));
    }
